    ...
    return (
      <AppLayout>
        <div className="max-w-7xl mx-auto px-6 py-10 space-y-10">
          <MotionWrapper>
            <div className="bg-linear-to-r from-purple-600 to-indigo-600 text-white rounded-2xl p-10 shadow-lg">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 space-y-10">
        ...
        <MotionWrapper>
          <div className="bg-linear-to-r from-purple-600 to-indigo-600 text-white rounded-2xl p-10 shadow-lg">
            <h1 className="text-3xl font-bold">Explore Events</h1>
            <p className="text-white/90 mt-2">
              Join competitions that match your skills and collaborate with
              strong teams.
            </p>
          </div>
        </MotionWrapper>
        ...
        <MotionWrapper>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white border border-neutral-200 rounded-xl p-6 text-center">
              <p className="text-sm text-neutral-500">Available Events</p>
